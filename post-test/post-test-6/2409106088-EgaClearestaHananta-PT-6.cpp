...
void sortHargaAscending(Kendaraan daftarKendaraan[], int jumlahKendaraan) {
    for (int i = 0; i < jumlahKendaraan - 1; i++) {
        for (int j = 0; j < jumlahKendaraan - i - 1; j++) {
            if (daftarKendaraan[j].harga_sewa > daftarKendaraan[j + 1].harga_sewa) {
                Kendaraan temp = daftarKendaraan[j];
                daftarKendaraan[j] = daftarKendaraan[j + 1];
                daftarKendaraan[j + 1] = temp;
            }
...
void lihatRiwayat(const Kendaraan daftarKendaraan[], int jumlahKendaraan, string nama, bool isAdmin = false) {
    // // system("cls");
    cout << "\n|=================================================================|\n";
                ...
                if (isAdmin) {
                    switch (pilihanMenu) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            lihatRiwayat(daftarKendaraan, jumlahKendaraan, namaPengguna, isAdmin);
                            break;
                        case 6:
                            loginState = false;
                    ...
                    switch (pilihanMenu) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            lihatRiwayat(daftarKendaraan, jumlahKendaraan, namaPengguna);
                            break;
                        case 4:
                            loginState = false;
                            cout << "Anda telah logout. Kembali ke menu awal..." << endl;
